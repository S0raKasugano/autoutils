# <img src="icon.png" width="48" height="48" alt="AutoUtils Icon" align="center" /> AutoUtils (Minecraft 26.3 & 26.2)

[![Author](https://img.shields.io/badge/Author-S0raKasugano-blue.svg)](https://github.com/S0raKasugano)
[![Minecraft](https://img.shields.io/badge/Minecraft-26.3%20%7C%2026.2-brightgreen.svg)](https://minecraft.net)
...
**AutoUtils** is a high-performance, client-side utility mod for **Minecraft 26.3** and **Minecraft 26.2** built on Fabric Loader. It provides combat utilities, survival automation, safety triggers, and a neat, categorized in-game Cloth Config GUI.
...
The production-ready mod jars are available under [GitHub Releases](https://github.com/S0raKasugano/autoutils/releases) or directly from the repository's `releases/` directory:

| Minecraft Version | Release Jar | Fabric API | Cloth Config |
|---|---|---|---|
| **Minecraft 26.3 (Latest)** | 👉 **[autoutils-1.0.0+26.3.jar](./releases/autoutils-1.0.0+26.3.jar)** | `0.161.0+26.3` | `26.3.159` |
| **Minecraft 26.2** | 👉 **[autoutils-1.0.0+26.2.jar](./releases/autoutils-1.0.0+26.2.jar)** | `0.160.0+26.2` | `26.2.155` |

### Requirements
- **Java**: `>= 25`
- **Fabric Loader**: `>= 0.19.x`
- **Fabric API**: Matching your Minecraft version
- **Cloth Config**: Matching your Minecraft version (`cloth-config-fabric`)
- **Mod Menu**: `20.0.x` (Recommended for in-game GUI access)

### Quick Install
1. Download the jar matching your Minecraft version (**`autoutils-1.0.0+26.3.jar`** for 26.3, or **`autoutils-1.0.0+26.2.jar`** for 26.2).
