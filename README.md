# AutoUtils - Advanced Fabric Client-Side Utility Mod (Minecraft 26.3)

**AutoUtils** is a complete, modular, client-side utility mod for Minecraft 26.3 (with branch `source-26.2` for Minecraft 26.2). Built on Fabric API, it introduces automation, combat aids, and emergency safety triggers while being 100% configurable in-game through Cloth Config and Mod Menu.
...
- Cloth Config 26.3.159 (`cloth-config-fabric`)
- Mod Menu 20.0.x
...
The compiled mod jar will be generated in `build/libs/autoutils-1.0.0+26.3.jar`. Place this jar into your `.minecraft/mods` directory alongside Fabric API and Cloth Config.
